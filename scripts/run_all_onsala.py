...
Downloads the ERA5 variables and writes te ARTS xml files.
...
def run_all_cases(p_grid, onsala, t0, outpath):
        ...
        # get all atmfields as a directory
        atm_fields  = onsala_atmdata(onsala, erap, p_grid, domain = domain)
...
if __name__ == "__main__":
    ...
    t0 = datetime(2020, 1, 1, 12, 00, 00)
    t1 = datetime(2022, 6, 30, 12, 00, 00)
